...
import { Applicant, Schedule, SystemUser } from '../types';
...
export default function ApplicantStatsModal({ applicant, currentUser, onClose }: Props) {
        ...
        { text: '1. Hane Bilgileri', style: 'sectionHeader' },
        {
          table: {
            ...
            body: [
              ...
              ['TC No', formatTC(applicant.tcNo)],
              ['Telefon', formatPhone(applicant.phone)],
        ...
        <div ref={reportRef} style={{ backgroundColor: '#ffffff', padding: '20px', color: '#000000' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '30px', border: '1px solid #e5e7eb', padding: '15px', borderRadius: '8px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
              ...
              <p><strong>T.C. Kimlik No:</strong> {formatTC(applicant.tcNo)}</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', textAlign: 'right' }}>
              ...
              <p><strong>İletişim:</strong> {formatPhone(applicant.phone)}</p>
            </div>
          </div>
