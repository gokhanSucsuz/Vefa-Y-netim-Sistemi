  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Tamamlanan Temizlikler</h2>
          <p className="text-sm text-gray-500 font-medium">Hizmet sunulan müracaatçıların listesi ve raporları</p>
        </div>
